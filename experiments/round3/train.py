"""Round3 transport-classification ablation; round1/2 artifacts stay frozen."""
import os
...
def main():
    ...
    parser.add_argument("--method", choices=["A", "flow_transport", "linear_transport"], required=True)
    ...
    config.update(batch_size=32, patch_size=7, train_n=len(train_loader.dataset),
                  ...
                  flow_source_gradient="detached; classification through source feature only",
                  experiment="round3_transport_classification", parent_protocol_sha256=file_hash(parent_lock),
